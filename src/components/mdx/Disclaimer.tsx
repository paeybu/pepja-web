...
export function Disclaimer() {
  return (
    <div className="border-y border-[color:var(--color-rule-strong)] py-4 text-sm leading-[1.85] text-[color:var(--color-ink-muted)]">
      <p className="m-0">
        <span className="font-semibold text-[color:var(--color-guide-safety)]">
